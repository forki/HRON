...
namespace Test.ServiceReference2 {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://HRONLib.Contracts/2017/04", ConfigurationName="ServiceReference2.IApprovalService")]
    public interface IApprovalService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://HRONLib.Contracts/2017/04/IApprovalService/startApprovalProcess", ReplyAction="http://HRONLib.Contracts/2017/04/IApprovalService/startApprovalProcessRespons" +
            "e")]
        Test.ServiceReference2.WFIdentification startApprovalProcess(string MailAddress, string MailBody, string MailSubject, System.TimeSpan WaitTime);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://HRONLib.Contracts/2017/04/IApprovalService/startApprovalProcess", ReplyAction="http://HRONLib.Contracts/2017/04/IApprovalService/startApprovalProcessRespons" +
            "e")]
        System.Threading.Tasks.Task<Test.ServiceReference2.WFIdentification> startApprovalProcessAsync(string MailAddress, string MailBody, string MailSubject, System.TimeSpan WaitTime);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://HRONLib.Contracts/2017/04/IApprovalService/sendApprovalResponse", ReplyAction="http://HRONLib.Contracts/2017/04/IApprovalService/sendApprovalResponseRespons" +
            "e")]
        bool sendApprovalResponse(Test.ServiceReference2.WFIdentification wfIdentification, bool approved, string note);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://HRONLib.Contracts/2017/04/IApprovalService/sendApprovalResponse", ReplyAction="http://HRONLib.Contracts/2017/04/IApprovalService/sendApprovalResponseRespons" +
            "e")]
        System.Threading.Tasks.Task<bool> sendApprovalResponseAsync(Test.ServiceReference2.WFIdentification wfIdentification, bool approved, string note);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IApprovalServiceChannel : Test.ServiceReference2.IApprovalService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ApprovalServiceClient : System.ServiceModel.ClientBase<Test.ServiceReference2.IApprovalService>, Test.ServiceReference2.IApprovalService {
        ...
        public Test.ServiceReference2.WFIdentification startApprovalProcess(string MailAddress, string MailBody, string MailSubject, System.TimeSpan WaitTime) {
            return base.Channel.startApprovalProcess(MailAddress, MailBody, MailSubject, WaitTime);
        }
        
        public System.Threading.Tasks.Task<Test.ServiceReference2.WFIdentification> startApprovalProcessAsync(string MailAddress, string MailBody, string MailSubject, System.TimeSpan WaitTime) {
